...
public class ExtendedDepthOfField_headless {
	...
	//
	private ImagePlus impComposite = null; //show
	private ImagePlus impHeightMap = null; //show
	
	public ImagePlus getHeightData() {
		return impHeightMap;
	}
	 ...
	 * Constructor.
	 */
	public ExtendedDepthOfField_headless (ImagePlus imp, Parameters parameters) {
